...
```{r}
par(mfrow = c(2,3))
hist(hotel_agg$review_t, main = NULL)
hist(hotel_agg$review_n, main = NULL)
hist(hotel_agg$review_p, main = NULL)
hist(hotel_agg$review_m, main = NULL)
hist(hotel_agg$reviewer_exp, main = NULL)
```
...
Identify a transformation using Boxcox. The nearest integer is 3, so we consider a transformation with lambda = 3.
...
It appears that all Cook's D values are smaller than 1.

Do we still need to remove obervation #1424 ?
