...
# consider transforming predictors
par(mfrow = c(2,3))
...
var.test(residuals(lmod0)[review_t1>10], residuals(lmod)[review_t1<10])
var.test(residuals(lmod0)[hotel_agg$review_p>28], residuals(lmod)[hotel_agg$review_p<28])
var.test(residuals(lmod0)[review_m1>5], residuals(lmod)[review_m1<5])
```
